...
@interface SyncSchedule : UIViewController<UITableViewDelegate, UITableViewDataSource>{
    id parent;
}
@property (strong, nonatomic) IBOutlet UITableView *tblViewSyncSchedule;
@property (nonatomic,retain) NSIndexPath *checkedIndexPath;
@property (nonatomic, retain) NSMutableArray* allValues;
@property (strong, nonatomic) NSString *syncScheduleString;

@property NSInteger numSyncString;
