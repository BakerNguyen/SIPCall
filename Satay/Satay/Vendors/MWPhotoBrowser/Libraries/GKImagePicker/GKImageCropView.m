...
- (UIImage *)croppedImage{
    ...
    if (visibleRect.size.height < 62.0 || visibleRect.size.width < 62.0) {
        [[CAlertView new] showError:_ALERT_CROP_SIZE_TOO_SMALL];
        return nil;
    }
    ...
    if (!result)
        result = [UIImage imageFromColor:[UIColor blackColor] Size:visibleRect];
