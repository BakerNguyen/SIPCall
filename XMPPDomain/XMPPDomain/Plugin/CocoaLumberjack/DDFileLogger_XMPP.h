...
**/
@interface DDLogFileManagerDefault_XMPP : NSObject <DDLogFileManager>
{
...
**/
@interface DDLogFileFormatterDefault_XMPP : NSObject <DDLogFormatter>
{
...
@interface DDFileLogger_XMPP : DDAbstractLogger_XMPP <DDLogger>
{
...
**/
@interface DDLogFileInfo_XMPP : NSObject
{
