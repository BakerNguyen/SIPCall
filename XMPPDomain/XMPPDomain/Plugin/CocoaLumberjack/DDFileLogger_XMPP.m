...
@interface DDLogFileManagerDefault_XMPP (PrivateAPI)
...
@interface DDFileLogger_XMPP (PrivateAPI)
...
@implementation DDLogFileManagerDefault_XMPP
                       ...
                       context:(void *)context
{
    ...
    if ([keyPath isEqualToString:NSStringFromSelector(@selector(maximumNumberOfLogFiles))])
    {
        ...
        dispatch_async([DDLog_XMPP loggingQueue], ^{ @autoreleasepool {
...
- (void)deleteOldLogFiles
{
    ...
    if (count > 0)
    {
        DDLogFileInfo_XMPP *logFileInfo = [sortedLogFileInfos objectAtIndex:0];
    ...
    {
        DDLogFileInfo_XMPP *logFileInfo = [sortedArchivedLogFileInfos objectAtIndex:i];
...
- (NSArray *)unsortedLogFileInfos
{
    ...
    for (NSString *filePath in unsortedLogFilePaths)
    {
        DDLogFileInfo_XMPP *logFileInfo = [[DDLogFileInfo_XMPP alloc] initWithFilePath:filePath];
...
- (NSArray *)sortedLogFilePaths
{
    ...
    for (DDLogFileInfo_XMPP *logFileInfo in sortedLogFileInfos)
    {
...
@implementation DDLogFileFormatterDefault_XMPP
...
- (NSString *)formatLogMessage:(DDLogMessage_XMPP *)logMessage
{
...
@implementation DDFileLogger_XMPP

- (id)init
{
    DDLogFileManagerDefault_XMPP *defaultLogFileManager = [[DDLogFileManagerDefault_XMPP alloc] init];
...
- (instancetype)initWithLogFileManager:(id <DDLogFileManager>)aLogFileManager
{
    if ((self = [super init]))
    {
        ...
        formatter = [[DDLogFileFormatterDefault_XMPP alloc] init];
    }
    return self;
}
...
- (unsigned long long)maximumFileSize
{
    ...
    dispatch_queue_t globalLoggingQueue = [DDLog_XMPP loggingQueue];
...
**/
- (DDLogFileInfo_XMPP *)currentLogFileInfo
{
    if (currentLogFileInfo == nil)
    {
        ...
        {
            DDLogFileInfo_XMPP *mostRecentLogFileInfo = [sortedLogFileInfos objectAtIndex:0];
        ...
        if (currentLogFileInfo == nil)
        {
            ...
            currentLogFileInfo = [[DDLogFileInfo_XMPP alloc] initWithFilePath:currentLogFilePath];
        }
    }
...
- (void)logMessage:(DDLogMessage_XMPP *)logMessage
{
...
@implementation DDLogFileInfo_XMPP
...
- (BOOL)isEqual:(id)object
{
    ...
    {
        DDLogFileInfo_XMPP *another = (DDLogFileInfo_XMPP *)object;
...
- (NSComparisonResult)reverseCompareByCreationDate:(DDLogFileInfo_XMPP *)another
{
...
- (NSComparisonResult)reverseCompareByModificationDate:(DDLogFileInfo_XMPP *)another
{
