...
@interface DDTTYLoggerColorProfile_XMPP : NSObject {
@public
    int mask;
    int context;
...
@implementation DDTTYLogger_XMPP
...
static DDTTYLogger_XMPP *sharedInstance;
...
- (void)setForegroundColor:(OSColor *)txtColor backgroundColor:(OSColor *)bgColor forFlag:(int)mask context:(int)ctxt
{
    dispatch_block_t block = ^{ @autoreleasepool {
        ...
        DDTTYLoggerColorProfile_XMPP *newColorProfile =
            [[DDTTYLoggerColorProfile_XMPP alloc] initWithForegroundColor:txtColor
        ...
        NSUInteger i = 0;
        for (DDTTYLoggerColorProfile_XMPP *colorProfile in colorProfilesArray)
        {
...
- (void)logMessage:(DDLogMessage_XMPP *)logMessage
{
    ...
    if (logMsg)
    {
        ...
        DDTTYLoggerColorProfile_XMPP *colorProfile = nil;
        ...
        if (colorsEnabled)
        {
            ...
            if (colorProfile == nil)
            {
                for (DDTTYLoggerColorProfile_XMPP *cp in colorProfilesArray)
                {
...
@implementation DDTTYLoggerColorProfile_XMPP
...
- (instancetype)initWithForegroundColor:(OSColor *)fgColor backgroundColor:(OSColor *)bgColor flag:(int)aMask context:(int)ctxt
{
    if ((self = [super init]))
    {
        ...
        if (fgColor)
        {
            [DDTTYLogger_XMPP getRed:&r green:&g blue:&b fromColor:fgColor];
        ...
        if (bgColor)
        {
            [DDTTYLogger_XMPP getRed:&r green:&g blue:&b fromColor:bgColor];
        ...
        if (fgColor && isaColorTTY)
        {
            ...
            fgCodeIndex = [DDTTYLogger_XMPP codeIndexForColor:fgColor];
        ...
        if (bgColor && isaColorTTY)
        {
            ...
            bgCodeIndex = [DDTTYLogger_XMPP codeIndexForColor:bgColor];
