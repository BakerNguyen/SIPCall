...
**/
@interface DDDispatchQueueLogFormatter_XMPP : NSObject <DDLogFormatter> {
@protected
...
**/
@interface DDDispatchQueueLogFormatter_XMPP (OverridableMethods)

- (NSString *)stringFromDate:(NSDate *)date;
- (NSString *)queueThreadLabelForLogMessage:(DDLogMessage_XMPP *)logMessage;
