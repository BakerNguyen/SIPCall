...
**/
@interface DDContextWhitelistFilterLogFormatter_XMPP : NSObject <DDLogFormatter>
...
**/
@interface DDContextBlacklistFilterLogFormatter_XMPP : NSObject <DDLogFormatter>
