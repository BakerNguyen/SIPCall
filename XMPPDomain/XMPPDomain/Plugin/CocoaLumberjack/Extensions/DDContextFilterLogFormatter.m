...
@interface DDLoggingContextSet_XMPP : NSObject
...
@implementation DDContextWhitelistFilterLogFormatter_XMPP
{
    DDLoggingContextSet_XMPP *contextSet;
}
...
- (id)init
{
    if ((self = [super init]))
    {
        contextSet = [[DDLoggingContextSet_XMPP alloc] init];
    }
    return self;
}
...
@implementation DDContextBlacklistFilterLogFormatter_XMPP
{
    DDLoggingContextSet_XMPP *contextSet;
}
...
@implementation DDLoggingContextSet_XMPP
{
    OSSpinLock lock;
    NSMutableSet *set;
}
