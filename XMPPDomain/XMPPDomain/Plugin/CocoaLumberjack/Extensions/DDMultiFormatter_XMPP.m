#import "DDMultiFormatter_XMPP.h"
...
@interface DDMultiFormatter_XMPP ()

- (DDLogMessage_XMPP *)logMessageForLine:(NSString *)line originalMessage:(DDLogMessage_XMPP *)message;

@end


@implementation DDMultiFormatter_XMPP {
...
- (NSString *)formatLogMessage:(DDLogMessage_XMPP *)logMessage {
    ...
    dispatch_sync(_queue, ^{
        for (id<DDLogFormatter> formatter in _formatters) {
            DDLogMessage_XMPP *message = [self logMessageForLine:line originalMessage:logMessage];
...
- (DDLogMessage_XMPP *)logMessageForLine:(NSString *)line originalMessage:(DDLogMessage_XMPP *)message {
    DDLogMessage_XMPP *newMessage = [message copy];
